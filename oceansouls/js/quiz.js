...
function optionSelected(answer){
    ...
    if(userAns == correctAns){
        ...
        //if answer is incorrect then automatically select the right one 
...
function queCounter(index){
    ...
    let totalQuesCountTag = '<span>'+ que_count +' of '+ questions.length +' Questions</span>'
